...
%     VCor15(:,1)+VCor15(:,2)>=ones(Totaltrain5,1);
%     VCor15+VCnot15==ones(Totaltrain5,2);
%     arf1left<=arf1;
%     arf1<=arf1right;
%     arf2left<=arf2;
%     arf2<=arf2right;
