...
for i=1:Totaltrain5-1
    ...
    for j=18:25
        if VCor15(i,2)==0
            x=[];
            y=[];
            x(1)=double(Departure5(i,j))-50;
            y(1)=a;
            x(2)=double(Departure5(i,j))+80;
            y(2)=a;
            x(3)=double(Arrival5(i,j+1))+80;
            y(3)=a-10;
            x(4)=double(Arrival5(i,j+1))-50;
            y(4)=a-10;
            x(5)=x(1);
            y(5)=y(1);
            A=fill(x,y,'y');
            ...
            y(1)=a-2;
            x(2)=double(Arrival5(i,j));
            y(2)=a+2;
            x(3)=double(Departure5(i,j));
            y(3)=a+2;
            x(4)=double(Departure5(i,j));
            y(4)=a-2;
            x(5)=x(1);
            y(5)=y(1);
            A=fill(x,y,'y');
        ...
        if VCor15(i,1)==0
            x=[];
            y=[];
            x(1)=double(Departure5(i,j))-80;
            y(1)=a;
            x(2)=double(Departure5(i,j))+50;
            y(2)=a;
            x(3)=double(Arrival5(i,j+1))+50;
            y(3)=a-10;
            x(4)=double(Arrival5(i,j+1))-80;
            y(4)=a-10;
            x(5)=x(1);
            y(5)=y(1);
            A=fill(x,y,'y');
